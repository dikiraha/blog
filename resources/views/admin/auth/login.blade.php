            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="{{ route('admin.auth.login') }}" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">DIKIRAHA</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                        ...
                        <form class="row g-3 needs-validation" method="post"
                            ...
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Enter your email or username" value="admin@dikiraha.com" autofocus />
                                    ...
                                    <div class="input-group input-group-merge">
                                        <div class="form-floating form-floating-outline">
                                            <input type="password" id="password" class="form-control"
                                                name="password"
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="password" value="12345" />
