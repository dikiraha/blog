                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">IT Support &middot; Development &middot; Design</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">Saya dapat membantu Anda</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Teruslah belajar
                                dan mencoba</span></h1>
                ...
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img" src="{{ asset('blog/assets/profile.png') }}" alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Tentang Saya</span>
                        </h2>
                        <p class="lead fw-light mb-4">Nama saya Muhammad Diki Dwi Nugraha.</p>
                        <p class="text-muted">Berperan dalam aktivitas IT (Information Technology) pada bagian
                            Hardware, Software dan Network.</p>
                        <p class="text-muted">Anda kesulitan? Sama, saya juga kesulitan.</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" href="https://www.instagram.com/dikiraha/" target="_blank"><i
                                    class="bi bi-instagram"></i></a>
                            <a class="text-gradient" href="https://wa.me/+6282125008160" target="_blank"><i
                                    class="bi bi-whatsapp"></i></a>
                            <a class="text-gradient" href="https://github.com/dikiraha" target="_blank"><i
