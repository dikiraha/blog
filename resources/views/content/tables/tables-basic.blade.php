        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td><i class="mdi mdi-basketball mdi-20px text-info me-3"></i><span class="fw-medium">Sports
                                Project</span></td>
                        <td>Barry Hunter</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="javascript:void(0);"><i
                                            class="mdi mdi-pencil-outline me-2"></i> Edit</a>
                                    <a class="dropdown-item" href="javascript:void(0);"><i
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-dark">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><i class="mdi mdi-greenhouse mdi-20px text-success me-3"></i><span
                                class="fw-medium">Greenhouse Project</span></td>
                        <td>Trevor Baker</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                    ...
                    <tbody>
                        <tr>
                            <td><i class="mdi mdi-wallet-travel mdi-20px text-danger me-3"></i><span
                                    class="fw-medium">Tours Project</span></td>
                            <td>Albert Cook</td>
                            <td>
                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <tr class="table-default">
                        <td><i class="mdi mdi-palette mdi-20px text-warning me-3"></i><span class="fw-medium">UI/UX
                                Project</span></td>
                        <td>Ronnie Shane</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-danger">
                        <td><i class="mdi mdi-palette mdi-20px text-danger me-3"></i><span class="fw-medium">UI/UX
                                Project</span></td>
                        <td>Sarah Banks</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-warning">
                        <td><i class="mdi mdi-shield-account-outline mdi-20px text-info me-3"></i><span
                                class="fw-medium">Custom Security</span></td>
                        <td>Ted Richer</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                    ...
                    <tr class="table-info">
                        <td><i class="mdi mdi-lifebuoy mdi-20px text-primary me-3"></i><span class="fw-medium">Latest
                                Bootstrap</span></td>
                        <td>Perry Parker</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-light">
                        <td><i class="mdi mdi-checkbox-marked-circle-plus-outline mdi-20px text-danger me-3"></i><span
                                class="fw-medium">Angular UI</span></td>
                        <td>Ana Bell</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                    ...
                    <tr class="table-dark">
                        <td class="rounded-start-bottom"><i
                                class="mdi mdi-waveform mdi-20px text-success me-3"></i><span
